...
if (count($_POST) && $_SERVER['REQUEST_URI'] != '/pcf' && $_SERVER['REQUEST_URI'] != '/yagate' && $_SERVER['REQUEST_URI'] != '/rksuccess' && $_SERVER['REQUEST_URI'] != '/rkresult' && $_SERVER['REQUEST_URI'] != '/rkfail' ) {
